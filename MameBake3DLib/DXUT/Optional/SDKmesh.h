...
struct SDKMESH_MESH
{
    ...
    ChaVector3 BoundingBoxCenter;
    ChaVector3 BoundingBoxExtents;
...
protected:
    ...
    ChaMatrix* m_pBindPoseFrameMatrices;
    ChaMatrix* m_pTransformedFrameMatrices;
...
protected:
    ...
    //frame manipulation
    void                            TransformBindPoseFrame( UINT iFrame, ChaMatrix* pParentWorld );
    void                            TransformFrame( UINT iFrame, ChaMatrix* pParentWorld, double fTime );
...
public:
    ...
    //Frame manipulation
    void                            TransformBindPose( ChaMatrix* pWorld );
    void                            TransformMesh( ChaMatrix* pWorld, double fTime );
...
//--------------------------------------------------------------------------------------
    ...
    ChaVector3                     GetMeshBBoxCenter( UINT iMesh );
    ChaVector3                     GetMeshBBoxExtents( UINT iMesh );
    ...
    const ChaMatrix* GetMeshInfluenceMatrix( UINT iMesh, UINT iInfluence );
