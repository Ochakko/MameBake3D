...
//--------------------------------------------------------------------------------------
ChaMatrix WINAPI DXUTGetCubeMapViewMatrix( DWORD dwFace )
{
    ...
    switch( dwFace )
    {
        case D3DCUBEMAP_FACE_POSITIVE_X:
            vLookDir = ChaVector3( 1.0f, 0.0f, 0.0f );
            vUpDir = ChaVector3( 0.0f, 1.0f, 0.0f );
            break;
        ...
        case D3DCUBEMAP_FACE_POSITIVE_Y:
            vLookDir = ChaVector3( 0.0f, 1.0f, 0.0f );
            vUpDir = ChaVector3( 0.0f, 0.0f, -1.0f );
            break;
        ...
        case D3DCUBEMAP_FACE_POSITIVE_Z:
            vLookDir = ChaVector3( 0.0f, 0.0f, 1.0f );
            vUpDir = ChaVector3( 0.0f, 1.0f, 0.0f );
            break;
    ...
    ChaMatrix mView;
    ChaMatrixLookAtRH( &mView, &vEyePt, &vLookDir, &vUpDir );
    return mView;
}
...
void CDXUTTextHelper::Begin()
{
    ...
    if( m_pSprite10 )
    {
        ...
        if( pd3dDevice )
        {
            ...
            ChaMatrixOrthoOffCenterRH( &matProjection, ( FLOAT )VPs[0].TopLeftX, ( FLOAT )
                                        ( VPs[0].TopLeftX + VPs[0].Width ), ( FLOAT )VPs[0].TopLeftY, ( FLOAT )
                                        ( VPs[0].TopLeftY + VPs[0].Height ), 0.1f, 10 );
            m_pSprite10->SetProjectionTransform((D3DXMATRIX*)&matProjection );
