...
btScalar gSliderNumThreads = 3.0f;                                                               // should be int
...
void CommonRigidBodyMTBase::setThreadNumFunc(int srcnum) {
	int taskschedulernum = gTaskSchedulerMgr.getNumTaskSchedulers();
	int i;
