...
public:
	...
	int Q2EulXYZ(CQuaternion* axisq, ChaVector3 befeul, ChaVector3* reteul);//bullet‚àXYZ‚Ì‡
...
{
	int buttonflag;//WM_LBUTTONDOWN-->PICK_L, WM_RBUTTONDOWN-->PICK_R, WM_MBUTTONDOWN-->PICK_MB‰Ÿ‚µ‚Ä‚¢‚È‚¢‚Æ‚«-->PICK_NONEB
				   //ˆÈ‰ºAbuttonflag‚ªPICK_NONEˆÈŠO‚Ì‚ÉˆÓ–¡‚ğ‚ÂB
	POINT mousepos;
	POINT mousebefpos;
	POINT clickpos;
...
typedef  struct tag_pervert
{
	...
	int				createflag;
	//’¸“_‚ğì¬‚µ‚È‚¢ê‡‚O
	//UV, VCOL, Materialno‚Ìˆá‚¢‚É‚æ‚èì¬‚·‚éê‡‚Í‚P‚ğ‘«‚·
	//normal‚É‚æ‚èì¬‚·‚éê‡‚Í‚Q‚ğ‘«‚·
