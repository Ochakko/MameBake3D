...
ChaVector3 CBone::CalcLocalTraAnim(int srcmotid, double srcframe)
{
	...
	ChaVector3 currotpos, curpos;
	ChaVector3TransformCoord(&curpos, &(GetJointFPos()), &curmat);
	ChaVector3TransformCoord(&currotpos, &(GetJointFPos()), &curglobalrotmat);
	ChaVector3 curanimtra = curpos - currotpos;
...
ChaVector3 CBone::CalcFBXEul(int srcmotid, double srcframe)
{
	CMotionPoint tmpmp;
