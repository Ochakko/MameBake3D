...
int CFpsSprite::CreateSprites(ID3D11Device* pdev, ID3D11DeviceContext* pd3dImmediateContext, WCHAR* mpath)
{
	...
	_ASSERT(m_sprite[10]);
	CallF(m_sprite[10]->Create(pd3dImmediateContext, mpath, L"fps_64x32.png", 0, 0), return 1);
...
int CFpsSprite::Render(ID3D11DeviceContext* pd3dImmediateContext, int srcfps)
{
