...
static SPGUISW s_spretargetsw[2];
...
void InitApp()
{
	...
	ZeroMemory(&s_spretargetsw, sizeof(SPGUISW) * 2);
...
void CALLBACK OnD3D11DestroyDevice(void* pUserContext)
{
	...
	*/
	...
	int sprigno;
	for (sprigno = 0; sprigno < 2; sprigno++) {
...
DbgOut( L"fbx : totalmb : r %f, center (%f, %f, %f)\r\n",
	...
	//if (inittimelineflag == 1) {//inittimelineflag は １つめのFBXのとき０、それ以降１
	{
		...
		s_model->SetCurrentMotion(motnum);//idは１からmotnum
	}
	//}
